      ...
      <div className="space-y-[18px]">
        ...
        <section className="bg-white rounded-[12px] p-5 shadow-[0px_2px_8px_rgba(0,0,0,0.04)] border border-slate-100/80">
          ...
          <div className="space-y-0">
            <div className="flex justify-between items-center pb-[14px] mb-[14px] border-b border-slate-100/80 cursor-pointer hover:opacity-70 active:scale-[0.98] transition-all">
              <div>
            ...
            <div className="flex justify-between items-center cursor-pointer hover:opacity-70 active:scale-[0.98] transition-all">
        ...
        {/* ACTIVE GOAL */}
        <section className="bg-white rounded-[12px] p-[18px] shadow-[0px_2px_8px_rgba(0,0,0,0.04)] border border-slate-100/80 cursor-pointer active:scale-[0.98] transition-transform">
        ...
        <section className="bg-white rounded-[12px] p-5 shadow-[0px_2px_8px_rgba(0,0,0,0.04)] border border-slate-100/80">
          ...
          <div className="space-y-[20px]">
            ...
            >
              ...
              <button className={\`w-11 h-6 rounded-full relative transition-colors focus:outline-none \${darkMode ? 'bg-[#0D47A1]' : 'bg-[#1e293b]'}\`}>
                <div className={\`w-[18px] h-[18px] rounded-full absolute top-0.5 shadow-sm transition-all \${darkMode ? 'bg-white right-1' : 'bg-[#cbd5e1] left-1'}\`}></div>
              </button>
            </div>
            ...
            >
              ...
              <button className={\`w-11 h-6 rounded-full relative transition-colors focus:outline-none \${pushNotifs ? 'bg-[#0D47A1]' : 'bg-[#1e293b]'}\`}>
                <div className={\`w-[18px] h-[18px] rounded-full absolute top-0.5 shadow-sm transition-all \${pushNotifs ? 'bg-white right-1' : 'bg-[#cbd5e1] left-1'}\`}></div>
              </button>
            </div>
            ...
            >
              ...
              <button className={\`w-11 h-6 rounded-full relative transition-colors focus:outline-none \${biometric ? 'bg-[#0D47A1]' : 'bg-[#1e293b]'}\`}>
                <div className={\`w-[18px] h-[18px] rounded-full absolute top-0.5 shadow-sm transition-all \${biometric ? 'bg-white right-1' : 'bg-[#cbd5e1] left-1'}\`}></div>
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-[12px] p-5 shadow-[0px_2px_8px_rgba(0,0,0,0.04)] border border-slate-100/80 mb-6">
          ...
          <div className="space-y-1">
            ...
            <button
              onClick={logout}
              className="mt-[6px] w-full flex items-center justify-center gap-2 py-[12px] bg-[#ffe4e4] text-[#A11D1D] font-semibold text-[15px] rounded-[8px] transition-all hover:bg-red-100 active:scale-[0.98]"
            >
...
console.log("Written updated SettingsView with toggles and active states!");
